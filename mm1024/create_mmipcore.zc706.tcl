create_peripheral user.org user mmipcore 1.0 -dir mmsystem_zc706/ip_repo
...
set_property  ip_repo_paths  mmsystem_zc706/ip_repo/mmipcore_1.0 [current_project]
update_ip_catalog -rebuild
ipx::edit_ip_in_project -upgrade true -name edit_mmipcore_v1_0 -directory mmsystem_zc706/ip_repo mmsystem_zc706/ip_repo/mmipcore_1.0/component.xml
update_compile_order -fileset sim_1

file copy -force interface/mmipcore_v1_0_S00_AXI.v mmsystem_zc706/ip_repo/mmipcore_1.0/hdl/

file copy -force interface/mmipcore_v1_0.v mmsystem_zc706/ip_repo/mmipcore_1.0/hdl/

if {[version -short] < "2019.2"} {
  file copy -force rtl/dsquare1040.v mmsystem_zc706/ip_repo/mmipcore_1.0/hdl/
  ...
  file copy -force rtl/invPD65.v mmsystem_zc706/ip_repo/mmipcore_1.0/hdl/
  ...
  file copy -force rtl/ma1040_65.v mmsystem_zc706/ip_repo/mmipcore_1.0/hdl/
  ...
  file copy -force rtl/minusP1040.v mmsystem_zc706/ip_repo/mmipcore_1.0/hdl/
  ...
  add_files -norecurse -copy_to mmsystem_zc706/ip_repo/mmipcore_1.0/src {rtl/minusP1040.v rtl/dsquare1040.v rtl/ma1040_65.v rtl/invPD65.v}
  update_compile_order -fileset sources_1
}
...
update_ip_catalog -rebuild -repo_path mmsystem_zc706/ip_repo/mmipcore_1.0
